...
function cambiarimagen(numero) {
    ...
    setTimeout(() => {
        if (numero === 1) imagenPrincipal.src = 'alejandra.jpg';
        else if (numero === 2) imagenPrincipal.src = 'andry.jpg';
        else if (numero === 3) imagenPrincipal.src = 'natalia.jpg';
        else if (numero === 4) imagenPrincipal.src = 'felipe.jpg';
        else if (numero === 5) imagenPrincipal.src = 'david.jpg';
        else if (numero === 6) imagenPrincipal.src = 'Modelo Entidad-Relación.png';
        imagenactual = numero;
